...
public class UserController {
	...
	public ResponseEntity<ApiResponse<Void>> alterName(@RequestBody UserNameAlterRequest request,
	...
	public ResponseEntity<ApiResponse<Void>> alterUserImage(@RequestBody UserImageAlterRequest imageUrl,
		@RequestParam Long userId) {
		try {
	...
	public ResponseEntity<ApiResponse<Void>> isMarketing(@RequestBody isMarketingRequest isMarketing,
		@RequestParam Long userId) {
		try {
